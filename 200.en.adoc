...
|Yes: Document using <<1a>> with supporting rationale. 
...
|Yes: Document using <<1c>> with supporting rationale. 

<<Go to 1.3>> 

|No:	Document using <<statement-1d>> with supporting rationale. 
