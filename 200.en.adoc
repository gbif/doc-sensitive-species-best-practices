...
|Yes
↓ +
Document using <<2a,Statement 2a>> with supporting rationale.
↓ +
...
|No:
↓ +
Document using <<2b,Statement 2b>> and supporting rationale.
↓ +
...
|Yes
↓ +
Document using <<2c,Statement 2c>> with supporting rationale.
↓ +
...
| No
↓ +
Document using <<2d,Statement 2d>> with supporting rationale.
↓ +
