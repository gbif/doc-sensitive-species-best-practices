...
Document using Statement 1a with supporting rationale. 

  _Statement 1a_: The taxon is at risk from a harmful human activity.
...
Document using Statement 1b:
  ...
  _Statement 1b_: There is no significant risk of a harmful human activity.
...
a|Yes: Document using <<1c,Statement 1c>> with supporting rationale. 

<<Go to 1.3>> 

a|No: Document using <<1d,Statement 1d>> with supporting rationale. 
