...
^a|*YES* +
↓ +
Document using statement 4c, collate all supporting rationale and document the decision to withhold the data: +
...
^a|*YES* +
↓ +
Document using statement 4d, collate all supporting rationale and document the decision to release the data.
...
^a|*YES* +
↓ +
Document using statement 4e, collate all supporting rationale and document the decision to release the data.
...
^a|*NO* +
↓ +
Document using statement 4g, collate all supporting rationale and document the decision to release the data.
