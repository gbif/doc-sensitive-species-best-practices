...
A set of scenarios using Criteria 1 and 2 (<<table-01,Table 1>>) for determining triggers for sensitivity of taxa is attached as an <annex-01,Annex>> to this document.
