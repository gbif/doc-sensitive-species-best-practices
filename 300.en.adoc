...
The list should be created using Criteria 1 and 2 (refer to <<Determining Sensitivity,the previous chapter>> and scenarios in Annex 1), and should include additional information such as:
